...
HD_PWD='C:/xilinx/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_lite_master_slave_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi4_lite_master_slave_top.tcl -notrace
