...
HD_PWD='C:/xilinx/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4_lite_master_slave_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4_lite_master_slave_top.tcl
